	...
	thematicAreas: [
		{
			...
			content:
				sectionToHtml([
					...
					"Under its awareness-raising initiatives, INWOLAG organises seminars, workshops, and voter education programs on topics such as caste discrimination, Indigenous women's rights in the constitution, and inclusive policies.",
					"INWOLAG has also filed three notable Public Interest Litigations (PIL): a case challenging the discriminatory tenure and representation of nominated women board members under the National Foundation for Upliftment of Aadibasi/Janjati Act, 2058 (2002); a 2009 PIL, filed together with LAHURNIP, NIWF-Nepal, NGO-FONIN and other Indigenous Peoples' Organizations, that secured a Supreme Court directive to amend electoral laws for direct representation of Indigenous Peoples in the Constituent Assembly; and an ongoing case in the Supreme Court seeking to annul Nepal's REDD+ process on the grounds that it threatens the rights of Indigenous peoples and dependent communities.",
				]),
	...
	teamMembers: [
		{
			...
			teamType: "BOARD",
			order: 1,
			bio: "Advocate Indira Kumari Shreesh is a senior legal practitioner and human rights scholar with over two decades of experience in advancing Indigenous peoples' rights, gender justice, and environmental governance. She holds a Master of Laws (LL.M.) in Human Rights and Gender Justice from Kathmandu School of Law, Purbanchal University, where she specialized in constitutional law, international human rights law, and legal protections for marginalized and Indigenous communities. She further completed a one-year postgraduate degree in Indigenous Studies and Development (MIED) from Kathmandu University, enhancing her interdisciplinary expertise in Indigenous land tenure systems, conservation governance, traditional livelihoods, and sustainable development policy. Her academic and research focus includes Indigenous land rights, conservation-induced displacement, hydropower and infrastructure impacts, livelihood protection, and intellectual property rights related to Indigenous knowledge and women's rights. Advocate Shreesh served as a Legal Fellow with the World Forum for Access to Justice (2013–2017) and was selected for the U.S. Government's International Visitor Leadership Program (IVLP). She is a practicing advocate at the Supreme Court of Nepal and the Founder and Chairperson of the Indigenous National Women Lawyers Association Group (INWOLAG).",
		},
		{
			name: "Adv. Uma Tamang",
			...
			teamType: "BOARD",
			order: 2,
			bio: "Uma Tamang is an Advocate and a dedicated human rights defender who has been working in the field of women's and children's rights for over two decades. She holds a Master's degree in Sociology from Trichandra College, Tribhuvan University, a Bachelor of Law from Nepal Law Campus, Tribhuvan University, and a Master's in Indigenous Education and Development from Kathmandu University. Since 2001, she has worked with Maiti Nepal as a Senior Legal Officer, trainer, and advocate, providing legal aid, leading awareness programs, and supporting survivors of human trafficking and gender-based violence. She is a member of the National Coordinating Committee for Controlling Human Trafficking (NCCHT), General Secretary of the National Network for Safe Migration (NNSM), an advisor to Bishwas Nepal, and a member of the Human Rights Treaty Monitoring Coordination Committee (HRTMCC). Uma Tamang has been directly involved in more than 200 cases related to human trafficking and sexual violence, including high-risk cross-border rescue missions, and has helped more than 60 orphaned children obtain citizenship and legal identity documents. As a founding member of INWOLAG, she has contributed to lobbying efforts and policy reviews from a Gender Equality and Social Inclusion (GESI) perspective, including engagement with the Legal Aid Act, Civil Code, and Criminal Code. She was awarded the Nepal Women Leaders Award (2018) by CMO Asia and the CNI Award (2022) by the Confederation of Nepalese Industries.",
		},
		{
			...
			teamType: "BOARD",
			order: 3,
			bio: "Kaushila Rai is an advocate and social activist with over 25 years of experience in Nepal's legal sector. She describes herself as a \"social engineer,\" reflecting her long-standing commitment to creating meaningful change through law, advocacy, and community engagement. She is a founding member of INWOLAG and currently serves as its General Secretary, where she works closely on advancing the rights of Indigenous women. Her work focuses on human rights, gender justice, and the empowerment of marginalized communities, with a strong emphasis on advocacy for Indigenous Peoples' women, including policy analysis related to CEDAW and research on land rights and Free, Prior and Informed Consent (FPIC). Previously, she served as Treasurer of the High Court Bar Association (Patan). She holds an LL.M. in Human Rights and Gender Justice and a Master's in Indigenous Education Development (MIED) from Kathmandu University, with certifications in court-referred mediation, trial advocacy, and Training of Trainers (TOT) for civil and criminal codes. She is a licensed member of the Nepal Bar Council (No. 4683) and continues to actively practice law.",
		},
		{
			...
			teamType: "BOARD",
			order: 4,
			bio: "Advocate Ritu Thapa is an Indigenous lawyer, human rights advocate, and trainer with over two decades of experience advancing the rights of Indigenous Peoples, particularly women and girls in Nepal. Her work focuses on strengthening access to justice, addressing violence against women (VAW), and advancing Indigenous Peoples' rights, including Free, Prior, and Informed Consent (FPIC), land rights, and equitable development, including legal advocacy for communities affected by large-scale development projects such as the Tanahu Hydropower Project. She holds a Master's degree in Law from the University of Pune and a Master's in Indigenous Education and Development from Kathmandu University. She is an alumna of the Human Rights Advocates Program (HRAP) and Indigenous Studies at Columbia University, New York, and has participated in international leadership programs including the East-West Center's Asia Pacific Leadership Program. She is a Distinguished Humphrey Fellow in Indigenous Peoples' Rights, was recognized as the second top-performing woman in the Advocate License Examination by the Nepal Bar Council, and is a recipient of the Nainoa Thompson Award from the East-West Center, University of Hawai'i.",
		},
		{
		...
		},
		{
			...
			teamType: "ADVISORY",
			order: 1,
			bio: "Sarada Subba is the founding chairperson of INWOLAG. She is a human rights lawyer with a Master's in Human Rights and Gender Justice from Kathmandu School of Law (KSL). She has been actively working as an activist for promoting the rights of women and Indigenous communities through advocacy, free legal aid, and training. She actively advises the board on their activities and engages in the organisation's programs.",
		},
		{
