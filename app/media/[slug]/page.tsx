...
import { ArrowLeft, Calendar, User, Tag, Video, Music, Film, Mic, Newspaper, FileQuestion } from "lucide-react";
  ...
  const renderMediaContent = () => {
    ...
    switch (media.mediaType) {
      case "VIDEO":
        ...
        if (media.mediaUrl.includes("youtube.com") || media.mediaUrl.includes("youtu.be")) {
