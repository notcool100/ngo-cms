...
const mediaFormSchema = z.object({
  ...
  mediaType: z.enum(["VIDEO", "AUDIO", "DOCUMENTARY", "INTERVIEW", "NEWS", "OTHER"], {
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription>
                        Assign a category to this media (optional).
                      </FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
                  ...
                  render={({ field }) => (
                    <FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-md border p-4">
                      ...
                      <div className="space-y-1 leading-none">
                        ...
                        <FormDescription>
                          Feature this media on the homepage and media listings.
                        </FormDescription>
                      </div>
                    </FormItem>
                  )}
              ...
              <div className="flex justify-end gap-4">
                ...
                <Button type="submit">
                  {isNew ? "Create Media" : "Update Media"}
                </Button>
              </div>
            </form>
          </Form>
	...
	return (
		<div className="container mx-auto py-6">
			...
			<Card>
				<CardHeader>
					<CardTitle>
						{isNew ? "Create a new media item" : "Update media item"}
					</CardTitle>
				</CardHeader>
				<CardContent>
					<Form {...form}>
